...
The **ordered_markers.RData** file is a large list with nine elements. Each element corresponds to a chromosome (e.g., CHR1). Each one of those elements contains objects, the original genotype matrix, the ordered genotype matrix and two plots (the order plot and the haplotype frequency plot).
